...
1. Add a second attribute by selecting **+ Add attribute** on the **Create the query to define groups** page. In the new field under the one you just configured, configure these values:
